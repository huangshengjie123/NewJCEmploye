...
@property (nullable, nonatomic, strong, readonly) NSDictionary<NSString *,XRClassIvarInfo *> *ivarInfos; //存储每一个属性的基本信息
@property (nullable, nonatomic, strong, readonly) NSDictionary<NSString *,XRClassMethodInfo *> *methodInfos; //存储该类的所有的方法的信息
@property (nullable, nonatomic, strong, readonly) NSDictionary<NSString *,XRClassPropertyInfo *> *propertyInfos; //存储
/**
 *  获得一个类的类信息 并加以缓存
 *  在出错的情况下有可能会返回nil
 */
