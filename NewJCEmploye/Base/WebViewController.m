...
@interface WebViewController ()<WKUIDelegate,WKNavigationDelegate,UITextFieldDelegate>
...
//    [self setupToolView];
    self.title = _nameString;
    /*
     *2.初始化progressView
     */
    self.progressView = [[UIProgressView alloc] initWithFrame:CGRectMake(0, JCNew64, [[UIScreen mainScreen] bounds].size.width, 2)];
...
- (void)startLoad {
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/boardDetail.html?id=%@&isAppLogin=true&jc4login=%@",config.mainBaseUrl,_stringID,token];
