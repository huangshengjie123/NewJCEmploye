...
@class JCModel_refundData3Staff, JCModel_refundData3Customer;

@interface JCModel_refundData3List : NSObject <NSCoding, NSCopying>

@property (nonatomic, strong) NSString *listIdentifier;
@property (nonatomic, assign) double guide;
@property (nonatomic, strong) JCModel_refundData3Staff *staff;
...
@property (nonatomic, strong) JCModel_refundData3Customer *customer;
@property (nonatomic, strong) NSArray *refundmentCosts;
@property (nonatomic, strong) NSString *type;
@property (nonatomic, strong) NSString *oid;
@property (nonatomic, strong) NSString *createTime;
@property (nonatomic, assign) id refundment;
